...
def parse_args():
    ...
    parser.add_argument(
        '--batch-size', type=int, default=16, help='num of max iter')
    parser.add_argument(
...
def measure_inference_speed(cfg, 
                            checkpoint, 
                            max_iter, 
                            log_interval,
                            is_fuse_conv_bn, 
    ...
    for i in range(max_iter):
        ...
        data["inputs"] = torch.randn((batch_size, 3, 640, 640)).cuda()
...
def main():
    ...
    repeat_measure_inference_speed(cfg, args.checkpoint, args.max_iter,
                                   ...
                                   args.repeat_num, args.batch_size)
